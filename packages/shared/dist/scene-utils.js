...
exports.countElementsByType = countElementsByType;
exports.stripDeleted = stripDeleted;
exports.isEmptyScene = isEmptyScene;
exports.sceneSummary = sceneSummary;
exports.mergeScenes = mergeScenes;
exports.blankScene = blankScene;
function elementsOf(scene) {
    return Array.isArray(scene?.elements) ? scene.elements : [];
}
function countElementsByType(scene) {
    const counts = {};
...
function blankScene(source = 'excalibur') {
