...
exports.normalizeAccelerator = normalizeAccelerator;
exports.resolveShortcuts = resolveShortcuts;
exports.acceleratorToCommand = acceleratorToCommand;
exports.findShortcutConflict = findShortcutConflict;
const features2_1 = require("./features2");
const KEY_ALIASES = {
    ' ': 'Space',
    ArrowUp: 'Up',
    ArrowDown: 'Down',
...
function normalizeAccelerator(e) {
    const parts = [];
...
function resolveShortcuts(overrides) {
    const map = {};
    for (const b of features2_1.DEFAULT_SHORTCUTS)
...
function acceleratorToCommand(overrides) {
...
function findShortcutConflict(overrides, commandId, accelerator) {
    const resolved = resolveShortcuts(overrides);
    for (const [cmd, acc] of Object.entries(resolved)) {
