 ...
 */
export function embedSceneInPng(pngBuffer, scene) {
    ...
    const sceneChunk = text.encode('excalidraw', JSON.stringify(scene));
 ...
 */
export function embedSceneInSvg(svg, scene) {
...
export function dataUrlToBuffer(data) {
